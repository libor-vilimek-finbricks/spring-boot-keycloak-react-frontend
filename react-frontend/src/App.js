    ...
    <div className="App">
      ...
      <div className="grid">
        <div className="col">
          ...
          <br/>
          <Button onClick={() => {
            fetch("http://localhost:8080/secured/userId", {
              headers: {
            ...
            .then(text => {
              setInfoMessage("Java Spring authorized user by Keycloak. UserID: " + text)
            })
            .catch(err => {
              setInfoMessage("Error happened: " + err.message);
            })
          }} className='m-1' label='Request Java Spring Backend with Authorization header' severity="success"/>
        </div>
      </div>
